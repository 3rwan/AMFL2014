...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FenServeur_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 26, 17)
    ...
    "FenServeur\0donneesRecues\0\0nouvelleConnexion\0"
};
...
const QMetaObject FenServeur::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_FenServeur.data,
      qt_meta_data_FenServeur,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FenServeur.stringdata))
